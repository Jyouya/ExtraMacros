...
function bind_keys(mod, k, v)
	...
	windower.text.set_color(_G[mod..'_text'][bind].text, T(v.color and {v.color.a,v.color.r,v.color.g,v.color.b} or {255, 255, 255, 255}):unpack())
	...
	windower.text.set_color(_G[mod..'_text'][bind].bind, T(v.color and {v.color.a,v.color.r,v.color.g,v.color.b} or {255, 255, 255, 255}):unpack())
